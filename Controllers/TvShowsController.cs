...
namespace TvShowsMVC.Controllers
{
    public class TvShowsController : Controller
    {
        private readonly TvShowsMVCContext _context;

        public TvShowsController(TvShowsMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TvShowsMVCContext.TvShow'  is null.");
            }
            var tvShow = await _context.TvShow.FindAsync(id);
            if (tvShow != null)
            {
